...
**Action:** When observing performance bottlenecks in tight parsing or resolution loops (like resolving function keys), cache string normalizations and regular expression substitutions where the cardinality of unique strings is low enough to fit in the LRU cache (e.g., `maxsize=4096`).
