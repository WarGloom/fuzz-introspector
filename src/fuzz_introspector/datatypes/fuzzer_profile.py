...
class FuzzerProfile:
    ...
    @staticmethod
    def _deserialize_branch_side(payload: Dict[str,
                                               Any]) -> branch_profile.BranchSide:
    ...
    def _serialize_calltree_node(
            cls, node: Optional[cfg_load.CalltreeCallsite]) -> Optional[Dict[
                str, Any]]:
        if node is None:
            return None
        return {
