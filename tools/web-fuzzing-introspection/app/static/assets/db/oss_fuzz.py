...
def _load_local_json(json_path, default_value):
...
def _get_local_report_artifacts_dir(report_dir):
...
def extract_local_report_function_list(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(
        os.path.join(artifacts_dir, 'all-fuzz-introspector-functions.json'),
        [])
...
def extract_local_report(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(os.path.join(artifacts_dir, 'summary.json'), {})


def extract_local_report_typedef(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    typedef_path = os.path.join(artifacts_dir, 'full_type_defs.json')
...
def extract_local_report_macro_block(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    macro_path = os.path.join(artifacts_dir, 'macro_block_info.json')
...
def extract_local_report_all_files(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(os.path.join(artifacts_dir, 'all-files.json'), [])


def extract_local_report_test_files(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(os.path.join(artifacts_dir, 'test-files.json'), {})


def extract_local_report_test_files_xref(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(
        os.path.join(artifacts_dir, 'all_tests_with_xreference.json'), {})
...
def extract_local_report_debug_info(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(os.path.join(artifacts_dir, 'all_debug_info.json'),
                            {})


def get_local_report_type_map(report_dir):
    artifacts_dir = _get_local_report_artifacts_dir(report_dir)
    return _load_local_json(
        os.path.join(artifacts_dir, 'all-friendly-debug-types.json'), {})
